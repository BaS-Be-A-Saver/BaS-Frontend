...
class MyPageSuccessScreen extends StatelessWidget {
  const MyPageSuccessScreen({super.key});
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        '+6',
                        style: AppFonts.bold
                            .copyWith(fontSize: 16, color: AppColors.red100),
                      )
                    ],
                  )
                ],
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          '오늘의 샤워 시간',
                          style: AppFonts.semibold.copyWith(color: AppColors.gray70,fontSize: 16),
                        ),
                        SizedBox(width: 20,),
                        Text(
                          '18 min 32 sec',
                          style: AppFonts.bold.copyWith(color: AppColors.black,fontSize: 20),
                        ),
                      ],
                    ),
                    SizedBox(height: 42,),
                    Text(
                      ...
                      style: AppFonts.special.copyWith(
                          fontSize: 36, color: AppColors.blue100, height: 1.0),
